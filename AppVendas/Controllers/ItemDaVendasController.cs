...
namespace AppVendas.Controllers
{
    public class ItemDaVendasController : Controller
    {
        ...
        {
            var applicationDdContext = _context.ItemDaVenda.Include(i => i.Produto).Include(i => i.Venda);
        ...
        {
            ViewData["ProdutoId"] = new SelectList(_context.Produtos, "ProdutosId", "ProdutosId");
        ...
        public async Task<IActionResult> Create([Bind("ItemDaVendaId,VendaId,ProdutoId,QtadeEstoque,ValorTotal")] ItemDaVenda itemDaVenda)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produtos, "ProdutosId", "ProdutosId", itemDaVenda.ProdutoId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ItemDaVendaId,VendaId,ProdutoId,QtadeEstoque,ValorTotal")] ItemDaVenda itemDaVenda)
        {
